...
import (
	...
	"github.com/asmisnik/reports-builder/internal/config"
	"github.com/asmisnik/reports-builder/internal/db"
	_ "github.com/asmisnik/reports-builder/internal/metrics"
	"github.com/asmisnik/reports-builder/internal/notifier"
	"github.com/asmisnik/reports-builder/internal/scheduler"
)
...
func main() {
	...
	sched := scheduler.New(database, notifierClient, logger, pollInterval)
	...
	logger.Info("reports-builder scheduler started", zap.Duration("poll_interval", pollInterval))
	go sched.Run(ctx)
